...
var CommentsService = (function () {
    ...
    CommentsService.prototype.getCommentforActivity = function (param) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.http.post('//localhost:4000/activities/getComments', JSON.stringify(param), { headers: headers })
            .map(function (res) { return res.json(); });
    };
    CommentsService.prototype.addCommentforActivity = function (param) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
...
//# sourceMappingURL=getComments.service.js.map